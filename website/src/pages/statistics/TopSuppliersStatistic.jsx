...
export default function TopSuppliersStatistic() {
    ...
    const fetchData = async () => {
      try {
        const response = await axios({
          method: 'GET',
          url: 'http://localhost:3000/statistics/topsuppliers',
          params: {
            serverInfo: document.getElementById('server-info-5').value || userInfo.server,
            minYear: document.getElementById('min-year-s').value || null,
            maxYear: document.getElementById('max-year-s').value || null
          }
        });
    ...
    const resetAllFilters = () => {
      document.getElementById('min-year-s').value = '';
      document.getElementById('max-year-s').value = '';
      fetchData();
    };
    ...
    return (
        ...
        <div className="overflow-y-auto h-96 rounded-xl shadow-lg shadow-zinc-900">
            ...
            <thead className="sticky top-0 bg-sky-700 text-white">
                ...
                <th className="py-2 px-4 border-b text-right">Ordenes</th>
