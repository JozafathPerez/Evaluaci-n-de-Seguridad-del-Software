...
export default function TopCustomersStatistic() {
    ...
    const fetchData = async () => {
      try {
        const response = await axios({
          method: 'GET',
          url: 'http://localhost:3000/statistics/topcustomers',
          params: {
            serverInfo: document.getElementById('server-info-3').value || userInfo.server,
            minYear: document.getElementById('min-year-c').value || null,
            maxYear: document.getElementById('max-year-c').value || null
          }
        });
    ...
    const resetAllFilters = () => {
      document.getElementById('min-year-c').value = '';
      document.getElementById('max-year-c').value = '';
      fetchData();
    };
    ...
    return (
        ...
        <div className="overflow-y-auto h-96 rounded-xl shadow-lg shadow-zinc-900">
            ...
            <thead className="sticky top-0 bg-sky-700 text-white">
                ...
                <th className="py-2 px-4 border-b text-right">Facturas</th>
                <th className="py-2 px-4 border-b text-right">Total Facturado</th>
            ...
            <tbody>
                ...
                <tr key={index} className="border-y-2 border-zinc-600 hover:bg-zinc-700">
                    ...
                    <td className="py-2 px-4 border-b text-right">{statistic.TotalAmount}</td>
